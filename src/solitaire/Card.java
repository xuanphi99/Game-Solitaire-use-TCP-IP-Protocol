...
public class Card extends JPanel{
		 ...
		 */
		// mảng enum chứa 4 chất rô,cơ,tép ,bích
		public enum Suit {
			Spades(1, false), // bich , co , ro , tep
			Hearts(2, true),
			Diamonds(3, true),
			Clubs(4, false);
		...
		public String toString() {
			...
			//System.out.println(valueString(value) + " of " + suit.name()+" -"+ dem);
		...
		public String saveAsString() {
                    System.out.println(valueString(value) + " of " + suit.name() + " of " + isReversed);
